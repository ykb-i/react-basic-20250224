...
export default function PathMove() {
    ...
    // - HTMl의 a 요소를 사용하는 경우는 프로젝트의 내부 이동이 아니라 외보루 이동하고자 할때만 사용
    ...
    const onClick = (event: MouseEvent<HTMLAnchorElement>) => {
        ...
        // window 객체의 location 객체의 href 속성값을 변경하여
        // 경로를 이동하면 요청을 새로 보냄.
        // 현재 웹 애플리케이션의 상태 유지 X
  ...
  return (
    <div>
      ...
      <Link to='/class' onClick={onClick}>링크 컴포넌트</Link>
    </div>
  )
}
